...
<Library LVVersion="20008000">
	...
	<Item Name="support" Type="Folder">
		<Item Name="private" Type="Folder">
			...
			<Item Name="insert into maps of sets.vim" Type="VI" URL="../support/insert into maps of sets.vim"/>
			<Item Name="UUID.lvclass" Type="LVClass" URL="../support/UUID/UUID.lvclass"/>
		</Item>
		<Item Name="ID.lvclass" Type="LVClass" URL="../api/ID/ID.lvclass"/>
	</Item>
	<Item Name="Graph.lvclass" Type="LVClass" URL="../api/Graph/Graph.lvclass"/>
	<Item Name="DiGraph.lvclass" Type="LVClass" URL="../api/DiGraph/DiGraph.lvclass"/>
